...
const MerchantDashboard = () => {
  ...
  const { stats, analytics } = useMemo(() => {
    ...
    return { stats: derived, analytics: { totalPickups, collectionRate, availabilityRate, health: Math.min(100, health || 0), revenueSeries, foodSeries, bestRevenueDay, peakPickupHour, categories, categoryGradient, timeline, periodLabel, revenueTrend: seriesTrend(revenueSeries), foodTrend: seriesTrend(foodSeries) } };
